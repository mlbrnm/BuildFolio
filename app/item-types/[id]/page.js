            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 bg-background border border-border rounded-md"
                  placeholder="e.g., Make, Model, CPU"
                />
              </div>
                  ...
                  {nestedField.fields.map((field, fieldIndex) => (
                    ...
                    >
                      ...
                      <div className="space-y-4">
                        <div>
                          <label
                            htmlFor={`nested-${nestedIndex}-field-${fieldIndex}-name`}
                            className="block text-sm font-medium text-foreground mb-1"
                          >
                            Field Name
                          </label>
                        ...
                        <div className="flex items-center">
                          <input
                            type="checkbox"
                            id={`nested-${nestedIndex}-field-${fieldIndex}-required`}
                            checked={field.required}
                            onChange={(e) =>
                              handleNestedSubfieldChange(
                                nestedIndex,
                          ...
                          />
                          <label
                            htmlFor={`nested-${nestedIndex}-field-${fieldIndex}-required`}
                            className="text-sm font-medium text-foreground"
                          >
                            Required
                          </label>
